...
abbreviations_high = {
        ...
        "3Obv": "Obviative ('fourth person', a way of distinguishing third persons from each other)",
        "3Pl": "Third person plural (they/them/theirs)",
        "4": "Obviative  ('fourth person', a way of distinguishing third persons from each other)",
